/*
  ...
  1. Issues Fixed
    - Direct referral bonuses not being distributed to uplines
    - Level income not being distributed to grand uplines
    - Sponsor income not being distributed when referrals achieve ranks

  2. Changes Made
    - Create new function to handle direct referral bonuses
    - Create new function to handle level income distribution
    - Create new function to handle rank sponsor bonuses
    - Update account activation function to trigger income distribution
