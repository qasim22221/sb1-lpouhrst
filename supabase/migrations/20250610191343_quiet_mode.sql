/*
  ...
  1. Changes Made
    - Drop the problematic profiles_id_fkey constraint
    - Create a login_lookup view for username checks without foreign key constraints
    - Update create_user_profile function to be more robust
